...
:: Range replacing
call :Replace_And_Check -p sample-test.txt -L 37 -N 40 -S -t "[\r\n]+" -o " -New-Line- " -R -c || goto :Pop_Exit_Error
...
call :Replace_And_Check -p sample-test.txt -b "\s*<pair" -Q "\s*</pair" -S -t "[\r\n]+" -o " -New-Line- " -R -c || goto :Pop_Exit_Error
...
call :Replace_And_Check -p sample-test.txt -L 37 -q "\s*</pair" -S -t "[\r\n]+" -o " -New-Line- " -R -c || goto :Pop_Exit_Error
call :Replace_And_Check -p sample-test.txt -b "\s*<pair" -Q "\s*</pair" -L 35 -S -t "[\r\n]+" -o " -New-Line- " -R -c || goto :Pop_Exit_Error
call :Replace_And_Check -p sample-test.txt -b "\s*<pair" -Q "\s*</pair" -L 35 -S -t "[\r\n]+" -o " -New-Line- " -q "\s*</pair" -R -c || goto :Pop_Exit_Error
call :Replace_And_Check -p sample-test.txt -b "\s*<pair" -Q "\s*</pair" -N 36 -S -t "[\r\n]+" -o " -New-Line- " -R -c || goto :Pop_Exit_Error
